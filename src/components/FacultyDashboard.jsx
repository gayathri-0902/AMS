            ...
            >
              ...
              <div className="bg-white rounded-[40px] p-10 shadow-sm border-t-8 border-purple-500 border-x border-b border-gray-100">
                ...
                {selectedSubjectOffering && (
                  <p className="text-sm font-bold text-gray-400 dark:text-slate-400 mb-6 uppercase tracking-widest bg-purple-50 dark:bg-purple-900/30 p-3 rounded-xl inline-block">
                    Target: <span className="text-purple-600">{selectedSubjectOffering.course_name}</span>
                  </p>
                )}
                <div onClick={() => noteFileRef.current?.click()} className="border-2 border-dashed border-purple-300 dark:border-purple-700 rounded-[24px] p-10 flex flex-col items-center justify-center bg-purple-50/30 dark:bg-purple-900/10 cursor-pointer mb-6 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors group">
                ...
                {notes.length > 0 && (
                  <div className="mt-8 pt-8 border-t border-purple-100">
                    ...
                    <div className="space-y-3 max-h-80 overflow-y-auto">
                      {notes.map((note) => (
                        <div key={note._id} className="flex justify-between items-center p-4 bg-gradient-to-r from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-2xl border border-purple-100 dark:border-purple-800">
                          <div>
              ...
              {(selectedClass || selectedSubjectOffering) && (
                <div className="bg-white dark:bg-slate-800 rounded-[40px] p-10 shadow-sm border-t-8 border-blue-500 border-x border-b border-gray-100 dark:border-slate-600">
                  ...
                  <div onClick={() => assignFileRef.current?.click()} className="border-2 border-dashed border-blue-300 dark:border-blue-700 rounded-[24px] p-10 flex flex-col items-center justify-center bg-blue-50/30 dark:bg-blue-900/10 cursor-pointer mb-6 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors group">
